...
[Windows](https://github.com/JD-P/miniloom/releases/download/v1.0.0/windows-2022-build.zip) [Mac OS](https://github.com/JD-P/miniloom/releases/download/v1.0.0/macos-latest-build.1.zip) [Ubuntu](https://github.com/JD-P/miniloom/releases/download/v1.0.0/ubuntu-latest-build.1.zip)
